# Werkstatt AI Capstone (Modul 2 MLOps)

**Difficulty:** 10/10 &middot; **Task type:** MLOps platform / federated umbrella
...
```bash
git clone https://github.com/Sandyyy123/liora-22-werkstatt.git
cd liora-22-werkstatt
